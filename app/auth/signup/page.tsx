      ...
      <div className="flex-1 bg-gradient-to-br from-violet-50 to-indigo-100 flex items-center justify-center p-4 py-6 md:py-8">
        <div className="w-full max-w-md mx-auto">
          ...
          <Link href="/" className="flex justify-center">
            ...
            <p className="text-muted-foreground">Join {siteName ?? process.env.NEXT_PUBLIC_SITE_NAME} today</p>
          </CardHeader>
                ...
                <Form className="space-y-6">
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="relative">
                        ...
                        <Field
                          ...
                          className={`pl-10 h-10 md:h-12 transition-colors ${
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-xs text-muted-foreground">
                      Format: +8801712345678 or 01712345678
                    </p>
                  </div>
                  ...
                  <Button
                    ...
                    className="w-full h-11 md:h-12 text-base md:text-lg font-medium disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                    {loading ? (
                      <motion.div
                        animate={{ rotate: 360 }}
